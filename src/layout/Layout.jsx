...
const Layout = ({ children }) => {
  ...
  return (
    <div className={`${theme ? "dark" : "light"}`}>
      <div className="w-full dark:bg-slate-900 dark:text-white h-screen overflow-hidden relative">
        <div>
          ...
          <div className="w-0 h-0 customShadow2 rounded-full bg-red-100 fixed bottom-0 left-72 max-lg:left-44 max-md:left-28 max-sm:left-5 shadow-2xl "></div>
        </div>
